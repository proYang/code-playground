...
/******/ 	var hotCurrentHash = "a95f91b8a542450a053d"; // eslint-disable-line no-unused-vars
...
var Main = function () {
  ...
  (0, _createClass3.default)(Main, [{
    ...
    value: function fetchArticleListAsync() {
      return _axios2.default.post("/graphql", 'query articleList { articleList { id title source authorId} }');
    }
  }, {
    key: 'fetchAuthorListAsync',
    value: function fetchAuthorListAsync() {
      return _axios2.default.post("/graphql", 'query authorList { authorList { id name} }');
    }
  }]);
  return Main;
}();
